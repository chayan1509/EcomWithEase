                    ...
                    <div class="sidebar-categories">
                        ...
                        <ul class="main-categories">
                            <li class="main-nav-list"><a data-toggle="collapse" href="#fruitsVegetable" aria-expanded="false" aria-controls="fruitsVegetable"><span
                                        class="lnr lnr-arrow-right"></span>SUV<span class="number"></span></a>
                                <ul class="collapse" id="fruitsVegetable" data-toggle="collapse" aria-expanded="false" aria-controls="fruitsVegetable">
                                    <li class="main-nav-list child"><a href="#">Compact crossover<span class="number"></span></a></li>
                                    <li class="main-nav-list child"><a href="#">Crossover<span class="number"></span></a></li>
                                    <li class="main-nav-list child"><a href="#">Mid-size<span class="number"></span></a></li>
                                    <li class="main-nav-list child"><a href="#">Full-size<span class="number"></span></a></li>
